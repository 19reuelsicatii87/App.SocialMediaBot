...
Feature: [TAA-38] [SEOReseller]: Registration
  ...
  Scenario Outline: TAA-104
    ...
    Examples: 
      ...
      | RND       | Automation | RNDAutomationTest15@gmail.com | happy123 | google | Go to my dashboard button | Philippines | This is a Test | I have more than 30 employees | Exceeds 20 Clients | www.test.com    |    9171111111 | Makati  |
