...
@CucumberOptions(
		format = { "pretty", "html:target/cucumber","json:target/JSON/WebAuditv2OutputRerun.json" },
        ...
        plugin = {"com.cucumber.listener.ExtentCucumberFormatter:target/SRSDashboardReportReRun.html","rerun:target/SrsWebAuditv2Rerun2.txt"}
...
public class R2_SrsSmokeTestWebAuditv2 extends WEBHelper{
	...
	{		
		...
		if (br.readLine() == null){
			...
			Mail.SendReport("SRSDashboardReportReRun.html", GetApplication() + GetTestEnv(), "[SMOKE TEST - RERUN]: " + GetApplication() + GetTestEnv() + " (WebAuditv2:"+testStatus+") - ");
